...
#ifndef SRC_RTTTLSONGS_H_
#define SRC_RTTTLSONGS_H_
...
void startPlayRandomRtttl(uint8_t aTonePin, void (*aOnComplete)()=NULL);
...
static const char Xfiles[] PROGMEM
...
static const char MASH[] PROGMEM
...
static const char TopGun[] PROGMEM
...
static const char *RTTTLsongs1[] = { Simpsons, Indiana, TakeOnMe, Entertainer, Muppets, Xfiles, Looney, _20thCenFox,
        Bond, MASH, StarWars, GoodBad, TopGun, A_Team, Flinstones, Jeopardy, Gadget, Smurfs, MahnaMahna,
        LeisureSuit, MissionImp };
